...
BASE_PROMPT = (
    ...
    "If using text anywhere, it must be oversized block lettering drawn as extremely bold, thick contour strokes so the SVG converter reliably keeps every character. "
